...
pipeline_single_sample() {
    ...
    # hisat2 -x combined_index -1 "trimmed/DE34NGSUKBR151851_1_val_1.fq.gz" -2 "trimmed/DE34NGSUKBR151851_2_val_2.fq.gz" -S "combined_sams/DE34NGSUKBR151851_combined.sam" --summary-file "combined_sams/DE34NGSUKBR151851_alignment_summary.txt"

    # echo "Start byPrim"
    # cat "combined_sams/DE34NGSUKBR151851_combined.sam" | python byPrim.py -s DE34NGSUKBR151851

    echo "Start Separating Files"
    TABLE="DE34NGSUKBR151851_1_table.tsv"
    FASTQ1="trimmed/DE34NGSUKBR151851_1_val_1.fq.gz"
    FASTQ2="trimmed/DE34NGSUKBR151851_2_val_2.fq.gz"
    echo "Extrahiere Human Read-IDs"
    awk '$4=="human"{print $1}' "$TABLE" > separated_files/DE34NGSUKBR151851_human_ids.txt
    echo "Extrahiere Mouse Read-IDs"
    awk '$4=="mouse"{print $1}' "$TABLE" > separated_files/DE34NGSUKBR151851_mouse_ids.txt
    echo "Erzeuge Human FASTQ .gz Dateien"
    seqtk subseq "$FASTQ1" separated_files/DE34NGSUKBR151851_human_ids.txt | gzip > "separated_files/DE34NGSUKBR151851_1_human.fq.gz"
    seqtk subseq "$FASTQ2" separated_files/DE34NGSUKBR151851_human_ids.txt | gzip > "separated_files/DE34NGSUKBR151851_2_human.fq.gz"
    echo "Erzeuge Mouse FASTQ .gz Dateien"
    seqtk subseq "$FASTQ1" separated_files/DE34NGSUKBR151851_mouse_ids.txt | gzip > "separated_files/DE34NGSUKBR151851_1_mouse.fq.gz"
    seqtk subseq "$FASTQ2" separated_files/DE34NGSUKBR151851_mouse_ids.txt | gzip > "separated_files/DE34NGSUKBR151851_2_mouse.fq.gz"

    # Human Reads mit Human Genome alignieren
    echo "Start Allignment of Human Samples"
    hisat2 -p 8 -x human_index -1 "separated_files/DE34NGSUKBR151851_1_human.fq.gz" -2 "separated_files/DE34NGSUKBR151851_2_human.fq.gz" -S "realligned_files/DE34NGSUKBR151851_human_final.sam"
    echo "Human reads alligned"
    echo "Start Allignment of Human Samples"
    # Mouse Reads mit Mouse Genome alignieren
    hisat2 -p 8 -x mouse_index -1 "separated_files/DE34NGSUKBR151851_1_mouse.fq.gz" -2 "separated_files/DE34NGSUKBR151851_2_mouse.fq.gz"  -S "realligned_files/DE34NGSUKBR151851_mouse_final.sam"
    echo "Mouse reads alligned"
    echo "Start BAM zu SAM"
    # SAM zu BAM konvertieren und sortieren
    samtools view -bS "realligned_files/DE34NGSUKBR151851_human_final.sam" | samtools sort -o "realligned_files/DE34NGSUKBR151851_human_final.sorted.bam"
    samtools view -bS "realligned_files/DE34NGSUKBR151851_mouse_final.sam" | samtools sort -o "realligned_files/DE34NGSUKBR151851_mouse_final.sorted.bam"
    echo "Start Index erstellen"
    # Index erstellen
    samtools index "realligned_files/DE34NGSUKBR151851_human_final.sorted.bam"
    samtools index "realligned_files/DE34NGSUKBR151851_mouse_final.sorted.bam"
    echo "Indexe erstellt"

    #counts human reads
    echo "Start FeatureCountHuman"
    featureCounts -T 8 -p -B -a Homo_sapiens.GRCh38.113.gtf -o "final_txt/DE34NGSUKBR151851_counts_human.txt" -g gene_id -t exon "realligned_files/DE34NGSUKBR151851_human_final.sorted.bam"
    echo "human reads sorted"
    #counts mouse reads
    echo "Start FeatureCountMouse"
    featureCounts -T 8 -p -B -a Mus_musculus.GRCm39.113.gtf -o "final_txt/DE34NGSUKBR151851_counts_mouse.txt" -g gene_id -t exon "realligned_files/DE34NGSUKBR151851_mouse_final.sorted.bam"
